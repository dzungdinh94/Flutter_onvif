...
class ONVIF {
  ...
  Future<OnvifDevice> _updateCapabilities(
      String username, String password, OnvifDevice device) async {
    String message =
  ...
  Future<String> getCameraUri(
      OnvifDevice device, String username, String password) async {
